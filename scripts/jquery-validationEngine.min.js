...
!function (a) {
    ...
    var b = {
        ...
        attach: function (c) {
            var e, d = this;
            return e = c ? b._saveOptions(d, c) : d.data("jqv"), e.validateAttribute = d.find("[data-validation-engine*=validate]").length ? "data-validation-engine" : "class", e.binded && (d.on(e.validationEventTrigger, "[" + e.validateAttribute + "*=validate]:not([type=checkbox]):not([type=radio]):not(.datepicker)", b._onFieldEvent), d.on("click", "[" + e.validateAttribute + "*=validate][type=checkbox],[" + e.validateAttribute + "*=validate][type=radio]", b._onFieldEvent), d.on(e.validationEventTrigger, "[" + e.validateAttribute + "*=validate][class*=datepicker]", {delay: 300}, b._onFieldEvent)), e.autoPositionUpdate && a(window).bind("resize", {
                noAnimation: !0,
                formElem: d
        ...
        hide: function () {
            var f, c = a(this).closest("form, .validationEngineContainer"), d = c.data("jqv"), e = d && d.fadeDuration ? d.fadeDuration : .3;
        ...
        _validateFields: function (c) {
            ...
            if (c.trigger("jqv.form.validating"), f = null, c.find("[" + d.validateAttribute + "*=validate]").not(":disabled").each(function () {
                ...
                if (d.scroll)if (g = f.offset().top, h = f.offset().left, i = d.promptPosition, "string" == typeof i && -1 != i.indexOf(":") && (i = i.substring(0, i.indexOf(":"))), "bottomRight" != i && "bottomLeft" != i && (j = b._getPrompt(f), j && (g = j.offset().top)), d.scrollOffset && (g -= d.scrollOffset), d.isOverflown) {
                    ...
                    l = k.scrollTop(), m = -parseInt(k.offset().top), g += l + m - 5, n = a(d.overflownDIV + ":not(:animated)"), n.animate({scrollTop: g}, 1100, function () {
                        d.focusFirstField && f.focus()
                    })
                } else a("html, body").animate({scrollTop: g}, 1100, function () {
                    d.focusFirstField && f.focus()
                }), a("html, body").animate({scrollLeft: h}, 1100); else d.focusFirstField && f.focus();
                return !1
            }
            return !0
        },
        ...
        _getCustomErrorMessage: function (a, c, d, e) {
            var h, i, j, f = !1, g = /^custom\[.*\]$/.test(d) ? b._validityProp.custom : b._validityProp[d];
            if (void 0 != g && (f = a.attr("data-errormessage-" + g), void 0 != f))return f;
            if (f = a.attr("data-errormessage"), void 0 != f)return f;
            if (h = "#" + a.attr("id"), "undefined" != typeof e.custom_error_messages[h] && "undefined" != typeof e.custom_error_messages[h][d])f = e.custom_error_messages[h][d].message; else if (c.length > 0)for (i = 0; i < c.length && c.length > 0; i++)if (j = "." + c[i], "undefined" != typeof e.custom_error_messages[j] && "undefined" != typeof e.custom_error_messages[j][d]) {
        ...
        _past: function (c, d, e, f, g) {
            var j, k, l, h = e[f + 1], i = a(c.find("*[name='" + h.replace(/^#+/, "") + "']"));
            if ("now" == h.toLowerCase())j = new Date; else if (void 0 != i.val()) {
        ...
        _creditCard: function (a, b, c, d) {
            var j, h, i, k, e = !1, f = a.val().replace(/ +/g, "").replace(/-+/g, ""), g = f.length;
        ...
        _ajax: function (c, d, e, f) {
            ...
            if ("object" == typeof i)a.extend(k, i); else if ("string" == typeof i)for (l = i.split("&"), e = 0; e < l.length; e++)m = l[e].split("="), m[0] && m[0] && (k[m[0]] = m[1]);
            if (j)for (o = String(j).split(","), e = 0; e < o.length; e++)p = o[e], a(p).length && (q = c.closest("form, .validationEngineContainer").find(p).val(), p.replace("#", "") + "=" + escape(q), k[p.replace("#", "")] = q);
        ...
        _buildPrompt: function (c, d, e, f, g) {
            ...
            return g.addPromptClass && h.addClass(g.addPromptClass), m = c.attr("data-required-class"), void 0 !== m ? h.addClass(m) : g.prettySelect && a("#" + c.attr("id")).next().is("select") && (n = a("#" + c.attr("id").substr(g.usePrefix.length).substring(g.useSuffix.length)).attr("data-required-class"), void 0 !== n && h.addClass(n)), h.css({opacity: 0}), "inline" === j ? (h.addClass("inline"), "undefined" != typeof c.attr("data-prompt-target") && a("#" + c.attr("data-prompt-target")).length > 0 ? h.appendTo(a("#" + c.attr("data-prompt-target"))) : c.after(h)) : c.before(h), l = b._calculatePosition(c, h, g), h.css({
            ...
            }, g.autoHideDelay), h.animate({opacity: .87})
        },
        ...
        _getPrompt: function (c) {
            var d = a(c).closest("form, .validationEngineContainer").attr("id"), e = b._getClassName(c.attr("id")) + "formError", f = a("." + b._escapeExpression(e) + ".parentForm" + b._getClassName(d))[0];
            return f ? a(f) : void 0
        },
        ...
        _calculatePosition: function (a, b, c) {
            var d, e, f, k, l, m, n, o, p, g = a.width(), h = a.position().left, i = a.position().top;
            ...
            return e += o, d += p, {callerTopPosition: d + "px", callerleftPosition: e + "px", marginTopSize: f + "px"}
        },
